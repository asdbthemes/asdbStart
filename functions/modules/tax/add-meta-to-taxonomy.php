...
function save_taxonomy_custom_meta( $term_id ) {
	...
	if ( isset( $_POST['tax_flag'] ) ) {
	delete_term_meta( $term_id, 'tax_flag' );
	add_term_meta( $term_id, 'tax_flag', $_POST['tax_flag'], true );
	}
}
...
function enqueue_admin_tax() {
	wp_enqueue_script( 'thickbox' );
	wp_enqueue_style('thickbox');
	wp_enqueue_script('media-upload');
}
add_action( 'admin_enqueue_scripts', 'enqueue_admin_tax' );