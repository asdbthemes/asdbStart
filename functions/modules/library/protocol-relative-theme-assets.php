 ...
 *
 * @package asdbbase
 * @since asdbbase 1.1.0
 */

if ( ! class_exists( 'asdbbase_protocol_relative_theme_assets' ) ) :
	class asdbbase_protocol_relative_theme_assets {
		/**
	...
	$asdbbase_protocol_relative_theme_assets = new asdbbase_protocol_relative_theme_assets;
endif;
