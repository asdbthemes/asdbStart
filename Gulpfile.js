...
var paths = {
	...
	php: ['./*.php', './**/*.php'],
	sass: ['assets/sass/**/*.scss', 'assets/components/fontawesome/scss'],
...
gulp.task('clean:pot', function() {
	return del(['languages/asdbstart.pot']);
});
...
gulp.task('wp-pot', ['clean:pot'], function() {
	...
	.pipe(wpPot({
		domain: 'asdbstart',
		destFile:'asdbstart.pot',
		package: 'asdbstart',
		bugReport: 'http://asdbthemes.ru/asdbstart/',
		lastTranslator: 'John Doe <mail@asdbthemes.ru/asdbstart/>',
		team: 'Team <mail@asdbthemes.ru/asdbstart/>'
	}))
...
gulp.task('watch', function() {
	...
	browserSync({
		...
		proxy: "asdbthemes.ru/asdbstart/",         // Use http://asdbthemes.ru/asdbstart/:3000 to use BrowserSync
		watchOptions: {
